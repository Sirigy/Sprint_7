...
public class ParameterizedCourierCreationTest {
    ...
    public static Collection<CourierModel> testData() {
        ...
        testData.addAll(CourierTestData.getInvalidCourierBodies()); // Невалидные данные
        testData.addAll(CourierTestData.getMissingRequiredFields()); // Отсутствующие обязательные поля
        return testData;
    }
