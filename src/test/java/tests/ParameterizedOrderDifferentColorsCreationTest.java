...
public class ParameterizedOrderDifferentColorsCreationTest {
    ...
    public static Collection<OrderModel> testData() {
        return OrderTestData.getOrdersWithOptionalColors(); // Получение тестовых данных
    }

    @Before
    public void setUp() {
        RestAssured.baseURI = OrderTestData.BASE_URL; // Установка базового URL
