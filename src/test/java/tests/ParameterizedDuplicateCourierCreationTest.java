...
public class ParameterizedDuplicateCourierCreationTest {
    ...
    public static Collection<CourierModel> testData() {
        return CourierTestData.getDuplicateLoginCouriers(); // Получение тестовых данных
    }
    ...
    public void setUp() {
        ...
        CourierModel courier = CourierTestData.getValidCourier(); // Получение валидного курьера
