...
public class LoginCourierTest {
    ...
    @Before
    public void setUp() {
        RestAssured.baseURI = CourierTestData.BASE_URL; // Установка базового URL
        courierSteps = new CourierSteps(); // Инициализация шагов для работы с курьерами
        courier = CourierTestData.getValidCourier(); // Получение валидного курьера
    ...
    public void courierCanNotLoginWithInvalidPassword() {
        CourierModel courierWithInvalidPassword = CourierTestData.getCourierWithInvalidPassword(); // Получение курьера с невалидным паролем
